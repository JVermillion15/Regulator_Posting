...
api_key <- "sG5swkh00UaEKj3O4+hPBVYptLx380Uk3fg9jRMFJbo=" ## Youre all good to use my key, just don't send me to jail hahahahaha
...
FDIC_Postings <- cbind(Organization_Name,Location, Position_ID,Position_Title,Renumeration,Low_Grade, High_Grade, Job_Summary)

###################################### Clean Up those ugly column names

new_names <- c("Organization","Location","Position ID","Position Title","Minimum Salary ($)","Maximum Salary ($)","Low Grade","High Grade","Description")
colnames(FDIC_Postings)[1:9] <- new_names
